...
alert(a);
// По идее код должен выводить тело функции (так утверждают компетентные источники))), 
...
// Поставил return в нужном месте: выводит 0 при любом значении аргумента. 
...
var a;
alert(a);
// Аналогично предыдущему примеру, выводится тело функции. Из двух команд, объявление а функцией и переменной, 
